...
public class Fuction extends ActionSupport {
	...
	public String tmpTitle, tmpPublisher, tmpPublishDate, tmpAuthorID,
			tmpPrice;
	public String tmpName, tmpAge, tmpCountry,tmptime;
	...
	public String getTmpAge() {
		return tmpAge;
	}

	public void setTmpAge(String tmpAge) {
		this.tmpAge = tmpAge;
	}
	...
	public String addauthor() throws SQLException {
		// System.out.println(tmpAuthorID+tmpName+tmpAge+tmpCountry);
		Statement stmt = t.createStatement();
		stmt.executeUpdate(" insert into Author values('" + tmpAuthorID + "','"
				+ tmpName + "','" + tmpAge + "','" + tmpCountry + "');");
		System.out.println("sdsdsd");
		return SUCCESS;
	}
	...
	public String searchteacher() throws SQLException {
		...
		while (set1.next()) {
			...
			teachertime1.setDay(set1.getInt(1));
			teachertime1.setTeacherid(set1.getInt(2));
			teachertime1.setTime1(set1.getInt(3));
			teachertime1.setTime1ed(set1.getInt(4));
			teachertime1.setTime2(set1.getInt(5));
			teachertime1.setTime2ed(set1.getInt(6));
			teachertime1.setTime3(set1.getInt(7));
			teachertime1.setTime3ed(set1.getInt(8));
			teachertime1.setTime4(set1.getInt(9));
			teachertime1.setTime4ed(set1.getInt(10));
			teachertime1.setTeachertimeid(set1.getInt(11));
